    ...
    <main className="py-16 px-4 md:px-8 lg:px-16">
      <div className="max-w-3xl mx-auto space-y-12">
        ...
        <section>
          ...
          <p className="leading-relaxed">
            {lang === 'de'
              ? 'Mein Name ist [Ihr Name], Gründer und alleiniger Ansprechpartner dieses Unternehmens. Mit jahrelanger Erfahrung in der Elektronikbranche lege ich Wert auf offene Kommunikation, schnelle Entscheidungswege und ein partnerschaftliches Miteinander. Ihre Zufriedenheit steht für mich stets an erster Stelle.'
              : 'My name is [Your Name], founder and sole contact of this company. With years of experience in the electronics industry, I value open communication, fast decision-making, and a partnership-based approach. Your satisfaction is always my top priority.'}
          </p>
        </section>
