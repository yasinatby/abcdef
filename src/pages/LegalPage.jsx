...
export default function LegalPage({ lang }) {
  return (
    <div className="max-w-4xl mx-auto px-4 py-10 text-gray-800 dark:text-gray-100 space-y-10">
      ...
      <section>
        ...
        <p className="mb-4">
          ...
          Zahlungsdaten werden direkt an Stripe übermittelt. Weitere Informationen: <a
            className="text-blue-500 underline" href="https://stripe.com/de/privacy" target="_blank"
            rel="noreferrer">
            Stripe-Datenschutz
          </a>. Die Verarbeitung erfolgt gemäß Art. 6 Abs. 1 lit. b DSGVO.
        </p>
